...
export class GroupsClient {
     ...
     * @return OK
     */
    getGroups(input: GetGroupsIn): Observable<GetGroupsOut | null> {
        let url_ = this.baseUrl + "/api/Groups/GetGroups";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<GetGroupsOut>><any>Observable.throw(e);
                }
            } else
                return <Observable<GetGroupsOut>><any>Observable.throw(response_);
        });
    }

    protected processGetGroups(response: Response): Observable<GetGroupsOut | null> {
        const status = response.status; 

        if (status === 200) {
            const _responseText = response.text();
            let result200: GetGroupsOut | null = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetGroupsOut.fromJS(resultData200) : new GetGroupsOut();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText);
        }
        return Observable.of<GetGroupsOut | null>(<any>null);
    }

    /**
     * @return OK
     */
    removeGroup(input: RemoveGroupIn): Observable<RemoveGroupOut | null> {
        let url_ = this.baseUrl + "/api/Groups/RemoveGroup";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processRemoveGroup(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processRemoveGroup(response_);
                } catch (e) {
                    return <Observable<RemoveGroupOut>><any>Observable.throw(e);
                }
            } else
                return <Observable<RemoveGroupOut>><any>Observable.throw(response_);
        });
    }

    protected processRemoveGroup(response: Response): Observable<RemoveGroupOut | null> {
        const status = response.status; 

        if (status === 200) {
            const _responseText = response.text();
            let result200: RemoveGroupOut | null = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? RemoveGroupOut.fromJS(resultData200) : new RemoveGroupOut();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText);
        }
        return Observable.of<RemoveGroupOut | null>(<any>null);
    }

    /**
     * @return OK
     */
    addGroup(input: AddGroupIn): Observable<AddGroupOut | null> {
        let url_ = this.baseUrl + "/api/Groups/AddGroup";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<AddGroupOut>><any>Observable.throw(e);
                }
            } else
                return <Observable<AddGroupOut>><any>Observable.throw(response_);
        });
    }

    protected processAddGroup(response: Response): Observable<AddGroupOut | null> {
        const status = response.status; 

        if (status === 200) {
            const _responseText = response.text();
            let result200: AddGroupOut | null = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? AddGroupOut.fromJS(resultData200) : new AddGroupOut();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText);
        }
        return Observable.of<AddGroupOut | null>(<any>null);
    }
}
...
export class GetGroupsIn implements IGetGroupsIn {
    result?: string | undefined;
    user?: User | undefined;

    constructor(data?: IGetGroupsIn) {
        if (data) {
    ...
    static fromJS(data: any): GetGroupsIn {
        let result = new GetGroupsIn();
        result.init(data);
        return result;
    }
...
export class GetGroupsOut implements IGetGroupsOut {
    groups?: Group[] | undefined;
    result?: string | undefined;
    user?: User | undefined;

    constructor(data?: IGetGroupsOut) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetGroupsOut {
        let result = new GetGroupsOut();
        result.init(data);
        return result;
    }
...
export interface IGetGroupsOut {
    groups?: Group[] | undefined;
    result?: string | undefined;
    user?: User | undefined;
}
...
export class RemoveGroupIn implements IRemoveGroupIn {
    group?: Group | undefined;
    result?: string | undefined;
    user?: User | undefined;

    constructor(data?: IRemoveGroupIn) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RemoveGroupIn {
        let result = new RemoveGroupIn();
        result.init(data);
        return result;
    }
...
export interface IRemoveGroupIn {
    group?: Group | undefined;
    result?: string | undefined;
    user?: User | undefined;
}

export class RemoveGroupOut implements IRemoveGroupOut {
    result?: string | undefined;
    user?: User | undefined;

    constructor(data?: IRemoveGroupOut) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RemoveGroupOut {
        let result = new RemoveGroupOut();
        result.init(data);
        return result;
    }
...
export interface IRemoveGroupOut {
    result?: string | undefined;
    user?: User | undefined;
}

export class AddGroupIn implements IAddGroupIn {
    group?: Group | undefined;
    result?: string | undefined;
    user?: User | undefined;

    constructor(data?: IAddGroupIn) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AddGroupIn {
        let result = new AddGroupIn();
        result.init(data);
        return result;
    }
...
export interface IAddGroupIn {
    group?: Group | undefined;
    result?: string | undefined;
    user?: User | undefined;
}

export class AddGroupOut implements IAddGroupOut {
    group?: Group | undefined;
    result?: string | undefined;
    user?: User | undefined;

    constructor(data?: IAddGroupOut) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AddGroupOut {
        let result = new AddGroupOut();
        result.init(data);
        return result;
    }
